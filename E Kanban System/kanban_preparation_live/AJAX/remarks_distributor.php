...
if($operation == "add_remarks_distributor"){
	...
	$distributor_remarks = $_GET['distributor_remarks'];
	...
	$params = array($id_scanned_kanban, $kanban, $kanban_num, $scooter_station, $scan_date_time , $request_date_time, $distributor_remarks, $sender_remarks, 'Production Remarks', $remarks_date_time, 'Unread');
    ...
    $params = array('Read', $seen_date_time, $id_scanned_kanban, $kanban, $kanban_num, $scan_date_time, $request_date_time, 'MM Remarks');
	$stmt = sqlsrv_query($conn_sqlsrv, $sql, $params);
