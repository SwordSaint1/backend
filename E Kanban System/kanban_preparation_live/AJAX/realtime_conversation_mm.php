...
if($operation == "count_conversation"){
	...
	$sql = "SELECT id FROM mm_remarks WHERE id_scanned_kanban='$remarks_id_scanned_kanban' AND kanban='$remarks_kanban' AND kanban_num='$remarks_kanban_num' AND scan_date_time='$remarks_scan_date_time' AND request_date_time='$remarks_request_date_time' AND sender_identification='Production Remarks'";
    $params = array();
