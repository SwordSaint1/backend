...
<body class="mt-0 mb-0">
	<?php
		...
		$sql1 = "SELECT * FROM tc_kanban_masterlist WHERE id ='$id' ORDER BY parts_name ASC, comment ASC";
		...
		if($result1->num_rows > 0){
			while($row1 = $result1->fetch_assoc()){
				...
				if ($comment == ''){
					...
					$sql3 = "SELECT route_no FROM route_no WHERE scooter_station = 'N/A'";
					...
					echo'
						...
						<tr>
							<td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Production Lot: </span><span style="font-size: 40px;" class="font-weight-bold">'.$production_lot.'</span></td><td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Station: </span><span style="font-size: 40px;" class="font-weight-bold">N/A</span></td>
						</tr>
						<tr>
						...
						if ($countChar > 15) {
							echo'
						<tr>
							<td colspan="2" class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 13px;"> Line No: </span><span style="font-size: 30px;" class="font-weight-bold">'.$line_no.'</span></td><td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Qty: </span><span style="font-size: 40px;" class="font-weight-bold">'.$quantity.'</span></td>
						</tr>';
						}
						else
						{
							echo'
						<tr>
							<td colspan="2" class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Line No: </span><span style="font-size: 40px;" class="font-weight-bold">'.$line_no.'</span></td><td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Qty: </span><span style="font-size: 40px;" class="font-weight-bold">'.$quantity.'</span></td>
						</tr>';
						}
						...
						<tr>
							<td colspan="2" rowspan="2" class="p0 pt-1"><center><img src="data:image/png;base64,' . base64_encode($generator->getBarcode(''.$serial_no.'', $generator::TYPE_CODE_128)) . '" class="pt-2 pb-2" style="width:420px; height:70px; "><br><label class="pt-1 font-weight-bold" style="font-size:18px;">'.$serial_no.'</label></center></td><td class="p-0"><span class="font-weight-bold mt-1 ml-2" style="font-size: 18px;"> Route </span><span style="font-size: 22px;" class="font-weight-bold pl-2">'.$route_no.'</span>
						</tr>
						<tr>
