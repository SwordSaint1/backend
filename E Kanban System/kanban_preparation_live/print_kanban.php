			...
			while($row2 = $result2->fetch_assoc()){
				...
				while($row=oci_fetch_assoc($query)){
					...
					echo'
						...
						<tr>
							<td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Quantity: </span><span style="font-size: 40px;" class="font-weight-bold">'.$quantity.'</span></td><td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Stock Address: </span><span style="font-size: 40px;" class="font-weight-bold">'.$stock_address.'</span></td><td><span class="font-weight-bold" style="font-size: 18px;">Station: </span><span style="font-size: 40px;" class="font-weight-bold"></span></td>
						</tr>
						<tr>
							<td rowspan="3" class="p-0"><center><img src="Images/white.png" class="pt-4 m-0 p-0" width="180px" id="identity_'.$request_id.'"></center></td><td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Order Date: </span><span style="font-size: 18px;" class="font-weight-bold pl-2">'.$scan_date_time.'</span></td><td rowspan="2"><span class="font-weight-bold" style="font-size: 18px;">Line: </span><span style="font-size: 40px;" class="font-weight-bold">'.$line_no.'</span></td>
						</tr>
						<tr>
							<td class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Delivery Date: </span><span style="font-size: 18px;" class="font-weight-bold pl-2">'.$delivery_time_new.'</span></td>
						</tr>
						<tr>
							<td colspan="2" class="p0 pt-1"><center><img src="data:image/png;base64,' . base64_encode($generator->getBarcode(''.$parts_name.'', $generator::TYPE_CODE_128)) . '" class="pt-2 pb-2" style="width:500px; height:100px; "><br><label class="pt-1 font-weight-bold" style="font-size:18px;">'.$parts_name.'</label></center></td>
						</tr>
						</tbody>
						</table>
					';
