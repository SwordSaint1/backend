...
<body class="bg">
	<div class="text-center w-auto h-100 mh-100 card_opa" style="margin-top:200px;">
		...
		<label class="text-center h1 text-danger">Access Denied...</label><br>
		<label class="text-center h2 text-danger">You will no longer have access to this system...</label>
	</div>
<!-- JQuery -->
...
<script>
setInterval(realtime_access, 5000);
function realtime_access(){
	...
	xhttp.open("GET", "AJAX/realtime_access.php", true);
	xhttp.send();
}
</script>
</body>
