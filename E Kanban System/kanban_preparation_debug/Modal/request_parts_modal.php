<div class="modal fade" id="Request_Parts" style="overflow-y: auto !important;" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body row">
				...
				<div class="md-form mb-0 col-sm-8">
				...
				<div class="text-center mb-0 mt-3 col-sm-12">
				...
				<div class="text-center col-sm-12 col-md-12 col-lg-12">
					<label class="h6 text-center text-danger" id="confirmation_output"> </label>
				</div>
			</div>
			<div class="modal-footer d-flex justify-content-center">
				<button class="btn unique-color white-text" onclick="save_request_parts()" id="btn_save_request" disabled> Request <i class="fas fa-paper-plane ml-1"></i></button>
			</div>
		</div>
	</div>
</div>