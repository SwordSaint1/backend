...
const count_conversation =()=>{
	...
	xhttp.open("GET", "AJAX/realtime_conversation_mm.php?operation=count_conversation&&remarks_id_scanned_kanban="+remarks_id_scanned_kanban+"&&remarks_kanban="+remarks_kanban+"&&remarks_kanban_num="+remarks_kanban_num+"&&remarks_scan_date_time="+remarks_scan_date_time+"&&remarks_request_date_time="+remarks_request_date_time+"&&scooter_station="+scooter_station, true);	
	xhttp.send();
}
...
const load_realtime_conversation =()=>{
	...
	xhttp.open("GET", "AJAX/realtime_conversation_mm.php?operation=load_realtime_conversation&&remarks_id_scanned_kanban="+remarks_id_scanned_kanban+"&&remarks_kanban="+remarks_kanban+"&&remarks_kanban_num="+remarks_kanban_num+"&&remarks_scan_date_time="+remarks_scan_date_time+"&&remarks_request_date_time="+remarks_request_date_time+"&&scooter_station="+scooter_station, true);
	xhttp.send();
}
...
// 	xhttp.send();
// }
//setInterval(check_conversation_section, 10000);
