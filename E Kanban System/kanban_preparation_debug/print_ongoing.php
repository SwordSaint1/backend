...
<body class="mt-0 mb-0">
	<?php
		...
		$sql = "SELECT * FROM mm_ongoing_picking WHERE id_scanned_kanban='$id_scanned_kanban' AND line_no LIKE '$print_category%' ORDER BY line_no ASC, stock_address ASC , parts_code ASC";
