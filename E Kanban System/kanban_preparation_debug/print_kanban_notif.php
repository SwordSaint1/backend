			...
			if($result->num_rows > 0){
				...
				while($row = $result->fetch_assoc()){
					...
					echo'
						...
						<tr>
							<td colspan="2" class="p-0 pl-2"><span class="font-weight-bold" style="font-size: 18px;"> Parts Code: </span><span style="font-size: 40px;" class="font-weight-bold">'.$row['parts_code'].'</span></td>
						</tr>
						';
						...
						<tr>
							<td colspan="2" rowspan="2" class="p0 pt-1"><center><img src="data:image/png;base64,' . base64_encode($generator->getBarcode(''.$row['serial_no'].'', $generator::TYPE_CODE_128)) . '" class="pt-2 pb-2" style="width:420px; height:70px; "><br><label class="pt-1 font-weight-bold" style="font-size:18px;">'.$row['serial_no'].'</label></center></td><td class="p-0"><span class="font-weight-bold mt-1 ml-2" style="font-size: 18px;"> Route </span><span style="font-size: 22px;" class="font-weight-bold pl-2">'.$route_no.'</span>
						</tr>
						<tr>
							<td class="p-0"><span class="font-weight-bold mt-1 ml-2" style="font-size: 18px;"> No </span><span style="font-size: 40px;" class="font-weight-bold pl-2">'.$kanban_no.'</span> <span style="font-size: 18px;" class="font-weight-bold pr-3 float-right mt-5">'.$page.'</span></td>
						</tr>
						</tbody>
						</table>
					';
