			...
			while($rows = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
				...
				echo'
					...
					<tr>
						...
						<td rowspan="2" class="p-0 pl-2 pt-0 pb-0"><span class="font-weight-bold" style="font-size: 18px;"> Kanban No.: </span><span style="font-size: 40px;" class="font-weight-bold pl-2">'.$kanban_num.' R</span><br><span style="font-size: 18px;" class="font-weight-bold pull-bottom pr-2 float-right">'.$page_num.' R</span></td>
					</tr>
					<tr>
				...
				// }else{
				// 	$sql4 = "DELETE FROM mm_scanned_kanban WHERE id = ? AND status=?";
				// 	$params4 = array($id, 'Pending');
