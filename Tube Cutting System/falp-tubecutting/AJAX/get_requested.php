...
if($operation == "display_all"){
	...
	$sql = "SELECT id, request_id, distributor, kanban, scooter_station, request_date_time, status FROM tc_scanned_kanban WHERE status='Pending' GROUP BY(request_id) ORDER BY id ASC";
			...
			if($result1->num_rows > 0){
				...
				echo'
					<tr class="'.$bgcolor.' '.$bgcolor1.' '.$color.' '.$color1.' " onclick="open_details_request(&quot;'.$row['request_id'].'~!~'.$row['status'].'&quot;)" style="cursor:pointer;" id="row_of_pending'.$row['request_id'].'">
						<td class="font-weight-normal" id="column_of_pending'.$row['request_id'].'">'.$no.'</td><td class="font-weight-normal">'.$row['request_id'].'</td><td class="font-weight-normal">'.$row['scooter_station'].'</td><td class="font-weight-normal">'.$row['request_date_time'].'</td><td class="font-weight-normal">'.$rowcount.'</td><td class="font-weight-normal">'.$row['distributor'].'</td>
					</tr>
				';
			}
		}
			...
			if($result1->num_rows > 0){
				...
				echo'
					<tr class="'.$bgcolor.' '.$bgcolor1.' '.$color.' '.$color1.'" onclick="open_details_request(&quot;'.$row['request_id'].'~!~'.$row['status'].'&quot;)" style="cursor:pointer;">
						<td class="font-weight-normal">'.$no.'</td><td class="font-weight-normal">'.$row['request_id'].'</td><td class="font-weight-normal">'.$row['scooter_station'].'</td><td class="font-weight-normal">'.$row['request_date_time'].'</td><td class="font-weight-normal">'.$rowcount.'</td><td class="font-weight-normal">'.$row['distributor'].'</td>
					</tr>
				';
			}
		}
