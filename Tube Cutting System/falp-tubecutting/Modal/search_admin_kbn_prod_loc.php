			...
			<div class="modal-body row">
				<div class="row col-sm-12 col-md-12 col-lg-12">
					...
					<div class="md-form mb-0 col-sm-3">
						...
						<label for="length_search1" id="length_search1_label" class="ml-3">Search Length:</label>
					</div>
					<div class="col-sm-12 col-md-12 col-lg-12">
						<button class="btn btn-info float-right" onclick="export_all_excel_search()" data-toggle="tooltip" data-placement="top" title="Export All"><i class="fas fa-file-download"></i> Excel</button>
					</div>
				</div>
				<div class="row col-sm-12 col-md-12 col-lg-12">
					<table class="table table-sm table-bordered">
						<thead class="blue-grey lighten-3">
							<tr>
                                ...
                                <th><strong>Prod. Loc.</strong></th>
								<th><strong>Indetification</strong></th>
