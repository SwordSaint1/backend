			...
			<div class="modal-body row">
				<div class="row col-sm-12 col-md-12 col-lg-12">
					...
					<div class="col-sm-12 col-md-12 col-lg-12">
						<button class="btn btn-info float-right" onclick="export_all_excel()" data-toggle="tooltip" data-placement="top" title="Export All"><i class="fas fa-file-download"></i> Excel</button>
					</div>
				</div>
				<div class="row col-sm-12 col-md-12 col-lg-12">
					<table class="table table-sm table-bordered">
						<thead class="blue-grey lighten-3">
							<tr>
								...
								<th><strong>Master Indetification</strong></th>
