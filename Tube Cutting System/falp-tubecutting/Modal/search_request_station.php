<div class="modal fade" id="Search_Modal_Form_Station" aria-labelledby="myModalLabel" aria-hidden="true" style='overflow:scroll;'>
		...
		<div class="modal-content">
			...
			<div class="modal-body row">
				<div class="row col-sm-12 col-md-12 col-lg-12">
					...
					<div class="md-form mb-0 col-sm-4">
						<input type="text" id="comment_search" class="form-control text-center">
						<label for="comment_search" id="comment_search_label" class="ml-3">Comment:</label>
					</div>
					<div class="md-form mb-0 col-sm-4">
						<input type="text" id="length_search" class="form-control text-center">
						<label for="length_search" id="length_search_label" class="ml-3">Length:</label>
					</div>
				</div>
				<div class="row col-sm-12 col-md-12 col-lg-12">
