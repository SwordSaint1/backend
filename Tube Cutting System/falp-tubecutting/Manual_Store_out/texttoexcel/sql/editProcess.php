...
session_start();
	...
	$dateJO = $_POST['dateJO'];
	$remarksforinterview = $_POST['remarksforinterview'];
	...
	if (($resultFinal =='p')||($resultFinal =='f')) {
		...
		echo $sqlFinal = "INSERT INTO tbl_finalhistory (`applicant_id`,`applicant_name`,`applied_position`,`final_department`,`final_interviewer`,`final_result`,`date`) VALUES  ('$listId','$name','$applied_position','$department','$interviewerFinal','$resultFinal','$dateFinal')";
		 ...
		 $sql = "UPDATE tbl_applicant set applicant_name = '$name', contact_no = '$contact_no', school = '$school', course = '$course', department = '$department', applied_position = '$applied_position', TOEIC_result = '$toeic', aptitude_result = '$total_aptitude', p1 = '$part1', p2 = '$part2', p3 = '$part3', assessment_result = '$assessment_result', date_applied = '$date_applied', status = '$status', date_of_orientation = '$date_of_orientation', remarks = '$remarks',initial_interviewer='$interviewerInitial',initial_result='$resultInitial',initial_date = '$dateInitial',final_interviewer='$interviewerFinal',final_result='$resultFinal',final_date='$dateFinal',jo_interviewer='$interviewerJO',jo_result='$resultJO',jo_date='$dateJO',interview_remarks='$remarksforinterview',emp_status = '$empStatus',gender='$gender' where listId = $listId limit 1";
