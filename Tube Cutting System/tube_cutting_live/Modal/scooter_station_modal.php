<div class="modal fade" id="Scooter_Station_Form" style="overflow-y: auto !important;" aria-labelledby="myModalLabel" aria-hidden="true" style='overflow:scroll;'>
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer d-flex justify-content-center">
				<button class="btn btn-info" onclick="save_station()" id="save_station_button"> Save <i class="fas fa-check"></i></button>
				<button class="btn btn-info" onclick="update_station()" id="update_station_button" style="display:none;"> Update <i class="far fa-edit"></i></i></button>
				<button class="btn btn-info" onclick="delete_station()" id="delete_station_button" style="display:none;"> Delete <i class="fas fa-trash"></i></button>
			</div>
		</div>
	</div>
</div>