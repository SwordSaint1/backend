<div class="modal fade" id="Add_Remarks_Form1" aria-labelledby="myModalLabel" aria-hidden="true" style='overflow:scroll;'>
			...
			<div class="modal-body row">
				...
				<div class="row col-sm-12 col-md-12 col-lg-12 mx-0">
					<div class="md-form mb-0 col-sm-12 col-md-12 col-lg-12 mx-0">
						<textarea id="distributor_remarks1" class="md-textarea form-control" rows="3"></textarea>
						<label for="distributor_remarks1" id="distributor_remarks1_Label" class="ml-3">Remarks</label>
					</div>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12 text-center">
					<label class="h6" id="out_distributor_remarks1"></label>
				</div>
			</div>
			<div class="modal-footer d-flex justify-content-center">
				<button class="btn btn-info" onclick="save_distributor_remarks1()" id="save_mm_remarks_button1"> Save <i class="fas fa-check"></i></button>
			</div>
		</div>
	</div>
</div>