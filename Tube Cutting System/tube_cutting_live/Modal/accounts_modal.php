<div class="modal fade" id="Accounts_Form" aria-labelledby="myModalLabel" aria-hidden="true" style='overflow:scroll;'>
		...
		<div class="modal-content">
			...
			<div class="modal-body row">
				...
				<div class="row col-sm-12 col-md-12 col-lg-12" id="name_of_station_section">
					...
					<div class="md-form mb-0 col-sm-6 col-md-6 col-lg-6">
						<input type="password" id="password" class="form-control text-center" value="Password">
			...
			<div class="modal-footer d-flex justify-content-center">
				<button class="btn btn-info" onclick="save_accounts()" id="save_accounts_button"> Save <i class="fas fa-check"></i></button>
				<button class="btn btn-info" onclick="update_accounts()" id="update_accounts_button" style="display:none;"> Update <i class="far fa-edit"></i></i></button>
				<button class="btn btn-info" onclick="delete_accounts()" id="delete_accounts_button" style="display:none;"> Delete <i class="fas fa-trash"></i></button>
			</div>
		</div>
	</div>
</div>