	...
	<?php
		...
		if($result1->num_rows > 0){
			while($row1 = $result1->fetch_assoc()){
				...
				$identification_qr = strtoupper($identification_qr);
					...
					echo'
						...
						<tr>
							...
							<td class="p-0 pl-2">
								...
								<span style="font-size: 40px;" class="font-weight-bold">'.$length.'</span>
							</td>
						</tr>';
						if ($comment1 != ''){
							$back_c = "black";
						...
						<tr>
							<td class="p-0">
								...
								<span style="font-size: 19px;" class="font-weight-bold pl-2">'.$request_date_time.'</span>
							</td>
							<td class="p-0">
						...
						<tr>
							<td colspan="2" rowspan="2" class="p0 pt-1">
								<center><img id="barcodeTable_'.$id.'" class="pt-2 pb-2" style="width:420px; height:70px;"><br>
									<label class="pt-1 font-weight-bold" style="font-size:18px;">'.$serial_no.'</label>
								</center>
							</td>
							<td class="p-0">
