...
{	 
	...
	echo $sql = "INSERT INTO tbl_applicant (`listId`,`applicant_name`,`contact_no`,`school`,`course`,`emp_status`,`department`,`applied_position`,`TOEIC_result`,`aptitude_result`,`p1`,`p2`,`p3`,`assessment_result`,`date_applied`,`status`,`date_of_orientation`,`remarks`,`initial_interviewer`,`initial_result`,`initial_date`,`final_interviewer`,`final_result`,`final_date`,`jO_interviewer`,`jo_result`,`jo_date`,`interview_remarks`,`gender`) 
	 	 VALUES 
	 	 ('','$name','$contact_no','$school','$course','$empStatus','$department','$applied_position','$toeic','$total_aptitude','$part1','$part2','$part3','$assessment_result','$date_applied','$status','$date_of_orientation','$remarks','$interviewerInitial','$resultInitial','$dateInitial','$interviewerFinal','$resultFinal','$dateFinal','$interviewerJO','$resultJO','$dateJO','$remarksforinterview','$gender')"; 
