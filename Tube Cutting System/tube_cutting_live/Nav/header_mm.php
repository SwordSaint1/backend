<nav class="navbar fixed-top navbar-expand-lg navbar-dark info-color">
    ...
    <div class="collapse navbar-collapse mt-2 mb-2" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li id="nav_kanban_missing_section" class="nav-item">
				<a class="nav-link" id="nav_missing_link" href="missing_kanban.php"> <i class="fas fa-print"></i> Missing Kanban </a>
			</li>
			<li id="nav_request_section" class="nav-item">
				<a class="nav-link" id="nav_notification_link" href="notification_tc.php"><i class="fas fa-bell"></i> Notification <span class="badge badge-danger" id="badge_notification"></span></a>
			</li>
