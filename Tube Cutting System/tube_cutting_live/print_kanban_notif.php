...
<body class="mt-0 mb-0">
		<?php
			...
			$sql = "SELECT * FROM tc_scanned_kanban WHERE id='$id' ORDER BY parts_name ASC, comment ASC";
					...
					echo'
						<tr>
							...
							<td class="p-0">
								...
								<span style="font-size: 18px;" class="font-weight-bold pl-2">4570 : FALP</span></td>
							<td rowspan="3" class="p-0 m-0 pt-1">
								<center>
									<div id="qrcodeTable_'.$id.'">
								</div></center>
							</td>
						...
						<tr>
							<td class="p-0">
								<span class="font-weight-bold mt-1 ml-2" style="font-size: 19px;"> Order </span>
								<span style="font-size: 19px;" class="font-weight-bold pl-2">'.$row['scan_date_time'].'</span>
							</td>
							<td class="p-0">
								<span class="font-weight-bold mt-1 ml-2" style="font-size: 19px;"> Delivery </span>
								<span style="font-size: 19px;" class="font-weight-bold pl-2">'.$delivery_time_new.'</span>
							</td>
							<td class="p-0">
								<span class="font-weight-bold mt-1 ml-2" style="font-size: 19px;"> Truck </span>
								<span style="font-size: 20px;" class="font-weight-bold pl-22">'.$truck_no.'</span>
							</td>
						</tr>
						<tr>
							<td colspan="2" rowspan="2" class="p0 pt-1">
								<center>
									<img id="barcodeTable_'.$id.'" class="pt-2 pb-2" style="width:420px; height:70px;">
									<br>
									<label class="pt-1 font-weight-bold" style="font-size:18px;">'.$row['serial_no'].'</label>
								</center>
							</td>
							<td class="p-0">
								<span class="font-weight-bold mt-1 ml-2" style="font-size: 18px;"> Route </span>
								<span style="font-size: 22px;" class="font-weight-bold pl-2">'.$route_no.'</span>
							</td>
						</tr>
						<tr>
							<td class="p-0">
								<span class="font-weight-bold mt-1 ml-2" style="font-size: 18px;"> No </span>
								<span style="font-size: 40px;" class="font-weight-bold pl-2">'.$kanban_no.'</span>
								<span style="font-size: 18px;" class="font-weight-bold pr-3 float-right mt-5">'.$page.'</span>
							</td>
						</tr>
						</tbody>
						</table>
