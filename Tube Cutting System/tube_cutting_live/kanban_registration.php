...
<script>
	...
	function select_all(){
		...
		xhttp.open("GET", "AJAX/kanban_masterlist.php?operation=select_all&&limiter_master=0", true);
		xhttp.send();
	}
	function count_all_master(){
		...
		xhttp.open("GET", "AJAX/kanban_masterlist.php?operation=count_all_master", true);
		xhttp.send();
	}
	function see_more_master(){
		...
		xhttp.open("GET", "AJAX/kanban_masterlist.php?operation=select_all&&limiter_master="+loader_count_master, true);
		xhttp.send();
	}
	...
	function delete_single_kanban_master(id){
		...
		document.getElementById('output_data_delete').innerHTML='';
		document.getElementById('idForDeleteHidden').value=id;
	}
	function master_delete_confirmed(){
		var idForDeleteHidden = document.getElementById('idForDeleteHidden').value;
		var xhttp = new XMLHttpRequest();
		xhttp.onreadystatechange = function(){
		if(this.readyState == 4 && this.status == 200){
			var response = this.responseText;
			document.getElementById('output_data_delete').innerHTML=response;
			line_no_search_action();
		}
		};
		xhttp.open("GET", "AJAX/kanban_masterlist.php?operation=master_delete_confirmed&&&&idForDeleteHidden="+idForDeleteHidden, true);
		xhttp.send();
	}
	function master_delete_cancel(){
		$("#Master_Delete_Confirm").modal('hide');
	}
	function cancel_delete(){
		$("#Master_Delete_Confirm").modal('hide');
	}

	function export_all_excel(){
		var line_no = document.querySelector('#line_no_search').value;
		var parts_code = document.querySelector('#parts_code_search1').value;
		var parts_name = document.querySelector('#parts_name_search1').value;
		var length = document.querySelector('#length_search1').value;

		window.open('export_search_masterlist.php?line_no='+line_no+
					'&&parts_code='+parts_code+
					'&&parts_name='+parts_name+
					'&&length='+length,'_blank');
	}
</script>
</body>
</html>
