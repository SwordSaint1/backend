...
<div class="card_opa mx-0">
	...
	<div class="row mx-0">
		...
		<div class="md-form mb-0 col-sm-3 col-md-3 col-lg-3" id="shifting_section">
			<select id="shifting_sched" class="browser-default form-control">
			  <option selected>Day Shift</option>
			  <option>Night Shift</option>
			</select>
		</div>
		<div class="md-form mb-0 col-sm-3 col-md-3 col-lg-3" id="scooter_station_select_section">
...
function search_action(){
	...
	var shifting_sched = document.getElementById('shifting_sched').value;
	...
	xhttp.open("GET", "AJAX/history_admin1.php?operation=display_all&&line_no="+line_no+"&&parts_code="+parts_code+"&&parts_name="+parts_name+"&&date_from="+date_from+"&&date_to="+date_to+"&&scooter_station="+scooter_station+"&&limiter_count=0&&shifting="+shifting_sched+"&&no=0", true);
	xhttp.send();
}
function count_all(){
	var line_no = document.getElementById('line_no').value;
	...
	xhttp.open("GET", "AJAX/history_admin1.php?operation=count_all&&line_no="+line_no+"&&parts_code="+parts_code+"&&parts_name="+parts_name+"&&date_from="+date_from+"&&date_to="+date_to+"&&scooter_station="+scooter_station+"&&shifting="+shifting_sched, true);
	xhttp.send();
}
function load_more_history(){
	...
	xhttp.open("GET", "AJAX/history_admin1.php?operation=display_all&&line_no="+line_no+"&&parts_code="+parts_code+"&&parts_name="+parts_name+"&&date_from="+date_from+"&&date_to="+date_to+"&&scooter_station="+scooter_station+"&&limiter_count=0"+total_load+"&&shifting="+shifting_sched+"&&no="+load_more_counter, true);
	xhttp.send();
}
function export_excel(){
	...
	window.open('export_history_all.php?line_no='+line_no+'&&parts_code='+parts_code+'&&parts_name='+parts_name+'&&date_from='+date_from+'&&date_to='+date_to+'&&scooter_station='+scooter_station+"&&shifting="+shifting_sched,'_blank');
}
function export_excel_showed(){
	...
	window.open('export_history_results.php?line_no='+line_no+'&&parts_code='+parts_code+'&&parts_name='+parts_name+'&&date_from='+date_from+'&&date_to='+date_to+'&&scooter_station='+scooter_station+"&&shifting="+shifting_sched+"&&limiter="+load_more_counter,'_blank');
}
</script>
