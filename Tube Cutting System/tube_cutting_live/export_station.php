...
';
$scooter_station = mysqli_real_escape_string($conn_sql, $_GET['scooter_area_select']);
...
$sql = "SELECT request_id, distributor, kanban, line_no, scooter_station, request_date_time, status FROM tc_history WHERE scooter_station='$scooter_station' AND (request_date_time >= '$date_from' AND request_date_time <= '$date_to') GROUP BY(request_id) ORDER BY id DESC";
